# Ticket 018: Adopt wellmanifest/new-project 0.20.32 managed package refresh
...
- [ ] AC-01: Run `create_adoption_lock.py` to upgrade from 0.20.14 to 0.20.32.
- [ ] AC-02: Run `install-agent-hosts.sh` and align `manifest.json`.
- [ ] AC-03: Pass repository tests and conformance.
